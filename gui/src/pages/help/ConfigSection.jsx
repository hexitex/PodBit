...
function ConfigSection() {
  const categoryList = [
    ...
    { name: 'Verification, Taint & Elite', desc: 'Content spec gate (pre-lab coherence filter, gated), lab framework (freeze, taint with BFS depth + embedding-similarity gate + decay, clears on supported/inconclusive), lab outcomes, API reconnaissance, decomposition, elite pool', icon: '✅' },
